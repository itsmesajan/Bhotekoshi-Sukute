            ...
            <div className="flex flex-col space-y-8">
              <div className="h-96 w-full overflow-hidden rounded-xl shadow-lg">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuD3ZyJyPhgzr9DwKv-6A-GJizyURVhFUky3TXksgjTP6J7xhb7WhvDBHGpPuRXp8IeQLysU2LYS15thQLkSbA_lEnhQ7f0jXQ_3TrqvriZ_-z_PPXRNMux2RKk_73XDsvri9ewjd1bZScsfuOy8ZXGwkydAjzu8QpZD_KUqB3PV_3Yyopdt7MojCRmJfKqt2AjiXhW7rpuvgBz3QSx1Tm7hyAcPeaJWWIW7-ZPl_tK5kNC1Wrfr8QH1oGK883SAGxvCN-poNQr2N3YM")',
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-subtle-light dark:text-subtle-dark">info@sukuteresort.com</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      <p className="mt-4 text-subtle-light dark:text-subtle-dark">{faq.answer}</p>
                    </details>
                  ))}
                </div>
              </div>
